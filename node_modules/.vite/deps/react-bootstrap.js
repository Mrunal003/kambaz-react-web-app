import {
  ...
  require_prop_types,
  require_warning
} from "./chunk-YA7VZDVY.js";
import {
  require_react_dom
} from "./chunk-H6ROQLGZ.js";
import {
  FormRange_default
} from "./chunk-PX6VXOLF.js";
import {
  FormContext_default
} from "./chunk-RHJOLI2U.js";
import {
  Anchor_default,
  Button_default,
...
function useTimeout() {
  ...
  const handleRef = (0, import_react19.useRef)();
...
var Carousel = React40.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react20.useRef)(null);
  const [direction, setDirection] = (0, import_react20.useState)("next");
  const [paused, setPaused] = (0, import_react20.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react20.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react20.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react20.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react20.useRef)();
  ...
  const handleEnter = (0, import_react20.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react20.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react20.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react20.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react20.useRef)(0);
  const touchDeltaXRef = (0, import_react20.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react20.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react20.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react20.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react20.useRef)();
  (0, import_react20.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react20.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react21.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react21.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react21.useCallback)((...args) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react25.useContext)(DropdownContext_default);
...
var Context = (0, import_react29.createContext)(canUseDOM_default ? window : void 0);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react30.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react30.useRef)(null);
  const focusInDropdown = (0, import_react30.useRef)(false);
  const onSelectCtx = (0, import_react30.useContext)(SelectableContext_default);
  const toggle = (0, import_react30.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener((0, import_react30.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react31.useLayoutEffect : import_react31.useEffect;
...
var context3 = React53.createContext(null);
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react32.useCallback)((refValue) => {
...
var DropdownMenu2 = React54.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react33.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react33.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React55.forwardRef(({
  ...
  const dropdownContext = (0, import_react34.useContext)(DropdownContext_default);
...
var Dropdown2 = React56.forwardRef((pProps, ref) => {
  ...
  const isInputGroup = (0, import_react35.useContext)(InputGroupContext_default);
...
var FormCheckLabel = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React64.forwardRef(({
  ...
  const innerFormContext = (0, import_react38.useMemo)(() => ({
    controlId: id || controlId
  }), [controlId, id]);
  const hasLabel = !children && label != null && label !== false || hasChildOfType(children, FormCheckLabel_default);
  const input = (0, import_jsx_runtime59.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime59.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime59.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime59.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime59.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormGroup = React66.forwardRef(({
  ...
  const context4 = (0, import_react39.useMemo)(() => ({
    controlId
  }), [controlId]);
...
function NoopTransition({
  ...
  const child = (0, import_react47.cloneElement)(children, {
    ref: combinedRef
  });
...
var _excluded4 = ["onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "addEndListener", "children"];
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react48.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React77.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime75.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react49.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime76.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime76.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime76.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react50.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime77.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime77.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime77.jsx)(import_jsx_runtime77.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime77.jsxs)(import_jsx_runtime77.Fragment, {
...
var Modal2 = React87.forwardRef(({
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime85.jsx)("div", {
    ...backdropProps,
...
var NavbarBrand = React88.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React89.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context4 = (0, import_react53.useContext)(NavbarContext_default);
...
var NavbarToggle = React90.forwardRef(({
  bsPrefix,
  className,
  children,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react55.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react56.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React91.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React92.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime90.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: getChildRef(children),
    children: (status, innerProps) => React92.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React93.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React94.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React95.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react57.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react57.useState)(false);
  const handleHide = useEventCallback2(onHide);
  ...
  const renderBackdrop = (0, import_react57.useCallback)((backdropProps) => (0, import_jsx_runtime93.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React96.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context4 = (0, import_react58.useContext)(NavbarContext_default);
...
var NavbarText = React97.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React98.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react59.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react59.useMemo)(() => ({
...
var NavDropdown = React99.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React100.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react61.useState)(!props.show);
...
var PopoverHeader = React101.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React102.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React104.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React105.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react62.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React106.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react63.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react63.useState)(null);
  ...
  return (0, import_jsx_runtime107.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React106.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React107.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react64.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react64.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react64.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react64.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react64.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react64.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react64.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime110.jsxs)(import_jsx_runtime109.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react64.cloneElement)(children, triggerProps), (0, import_jsx_runtime108.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React108.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React108.forwardRef(({
    children,
    ...props
...
var Pagination = React109.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React110.forwardRef((props, ref) => {
...
var Placeholder = React111.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React112.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react65.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react66.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react67.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react67.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime129.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastFade = React125.forwardRef((props, ref) => (0, import_jsx_runtime131.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React126.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React127.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react68.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
...
var ToastBody = React128.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React129.forwardRef(({
  ...
  const delayRef = (0, import_react69.useRef)(delay);
  const onCloseRef = (0, import_react69.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react69.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react69.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToastContainer = React130.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React131.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React132.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
