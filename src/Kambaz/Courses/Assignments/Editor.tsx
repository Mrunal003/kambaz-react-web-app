...
export default function AssignmentEditor() {
  ...
  const [due_date, setDueDate] = useState(assignment?.due_date || "");
  const [points, setPoints] = useState(assignment?.points || "");
  const [available_from, setAvailableFrom] = useState(assignment?.available_from || "");
  const [available_until, setAvailableUntil] = useState(assignment?.editor_due_date || "");
                ...
                <Row>
                  <Col>
                    <Form.Group controlId="wd-due-date">
                      ...
                      <Form.Control type="date" value={due_date} onChange={(e) => setDueDate(e.target.value)} />
                    </Form.Group>
                  </Col>
                </Row>
                <Row className="mb-3">
                  <Col sm={6}>
                    <Form.Group controlId="wd-available-from">
                      ...
                      <Form.Control type="date" value={available_from} onChange={(e) => setAvailableFrom(e.target.value)} />
                    </Form.Group>
                  </Col>
                  <Col sm={6}>
                    <Form.Group controlId="wd-available-until">
                      <Form.Label><strong>Until</strong></Form.Label>
                      <Form.Control type="date" value={available_until} onChange={(e) => setAvailableUntil(e.target.value)} />
                    </Form.Group>
                  </Col>
                </Row>
              </Col>
