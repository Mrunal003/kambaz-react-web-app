...
//             <td className="wd-role">STUDENT</td>
//             <td className="wd-last-activity">2021-08-30</td>
...
//             <td className="wd-role">STUDENT</td>
//             <td className="wd-last-activity">2022-01-12</td>
//             <td className="wd-total-activity">8:45:22</td>
//           </tr>
//         </tbody>
//       </Table>
//     </div>
        ...
        <tbody>
          {users
            .filter((usr) =>
              enrollments.some(
                (enrollment) =>
                  enrollment.course === cid && enrollment.user === usr._id
              )
            )
            .map((user: any) => (
              <tr key={user._id}>
